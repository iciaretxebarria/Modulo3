...
namespace EjercicioDepartamentos.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public EmpleadosController(EjercicioDepartamentosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string nombreBuscado)
        {
            ...
            {
                return View(await _context.Empleado.Include(x => x.Departamento).Where(x => x.Nombre.Contains(nombreBuscado)).ToListAsync());

            }


            var ejercicioDepartamentosContext = _context.Empleado.Include(e => e.Departamento);
            return View(await ejercicioDepartamentosContext.ToListAsync());
        }
